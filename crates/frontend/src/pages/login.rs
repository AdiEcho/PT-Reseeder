                ...
                view! {
                    ...
                    ">
                        ...
                        ">
                            ...
                            // Only show the toggle link when a user already exists
                            // (i.e. allow switching to register mode only if no user yet,
                            //  but that case is already defaulted above — so this link
                            //  only appears for "back to login" or is hidden entirely).
                            {move || {
                                if has_existing_user {
                                    // User exists: no registration allowed, hide toggle
                                    view! { <div /> }.into_any()
                                } else {
                                    // No user yet: show toggle between register/login
                                    view! {
                                        <p style="
                                            text-align: center;
                                            margin-top: 24px;
