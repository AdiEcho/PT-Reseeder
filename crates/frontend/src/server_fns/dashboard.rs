// Dashboard: aggregate DTOs and the single server function feeding the
// overview page. `SiteUserInfo` (nested in `UserInfoAggregate`) lives in
// `sites.rs` next to the other site DTOs.
